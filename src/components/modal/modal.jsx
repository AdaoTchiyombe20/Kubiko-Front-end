      ...
      >
        ...
        <Modal.Header className='border-0 p-0' closeButton = {showLocalModal == 'scheduleVisit' ? true : false}>
          <Modal.Title className='fw-semibold fs-3'>
            ...
            {showLocalModal == 'setProfile' && 'Configurar Perfil'}
        ...
        <Modal.Body className='p-0'>
                ...
                (
                    <div className='d-flex flex-column align-items-center gap-3 mb-3'>
                        <div className='d-flex flex-column gap-2 w-100'>
                            ...
                            <button className={`${styles.phoneAuthenticationButton} w-100 d-flex justify-content-center align-items-center gap-2 py-2 border-0 rounded-3`} onClick={()=>{
                                setShowLocalModal('phone')
                            }}>
                                <Call02Icon />
                                Entrar com telefone
                            </button>
                        </div>
                        <p className='d-flex align-items-center gap-1 m-0 text-center'>Não tem uma conta? <a href="#" className='text-decoration-none text-primary'>Criar Conta</a></p>
                    </div>
                )
            }
            {
            ...
            }
            {
                ...
                (
                    <form className={`${styles.setProfileForm} d-flex flex-column align-items-center gap-2`} onSubmit={(e)=>{
                        e.preventDefault()
                    }}>
                        <div className='d-flex flex-column gap-2 w-100'>
                            <label htmlFor="" className='ps-1'>Nome Completo</label>
                        ...
                        <div className='d-flex flex-column gap-1 w-100 mb-4'>
                            ...
                            <input type="text" name="name" placeholder='nome@gmail.com'/>
                        </div>
                        <button type='submit' className={`${styles.sendPhoneCodeButton} btn btn-primary w-100 d-flex justify-content-center align-items-center gap-2 py-2 border-0 rounded-3`} onClick={()=> handleShowModal()}>
                            Configurar perfil
                        </button>
                    </form>
                )
